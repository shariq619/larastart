...
<head>
    ...
    <title>Jjokers-Admin-Panel</title>
    <!-- Font Awesome Icons -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="javascript:" class="brand-link">
            <img src="{{asset('admin/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Jjokers-Admin-Panel</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{route('badges.index')}}" class="nav-link {{ (request()->is('admin/badges*')) ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Badges management</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('ads.index')}}" class="nav-link {{ (request()->is('admin/ads*')) ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Ads/banner management</p>
                        </a>
                    </li>
                    <li class="nav-item">
